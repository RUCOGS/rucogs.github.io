...
export interface CreateEboardTermDialogData {
  eBoardId: string;
  takenYears: number[];
}

@Component({
  selector: 'app-create-eboard-term-dialog',
  templateUrl: './create-eboard-term-dialog.component.html',
  styleUrls: ['./create-eboard-term-dialog.component.css'],
})
export class CreateEboardTermDialogComponent {
  form: FormGroup;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateEboardTermDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: CreateEboardTermDialogData,
  ) {
