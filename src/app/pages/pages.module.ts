...
const routes: Route[] = [
  ...
  { path: 'pictures', loadChildren: () => import('./pictures//pictures-page.module').then(m => m.PicturesPageModule) },
  { path: 'resources', loadChildren: () => import('./resources/resources-page.module').then(m => m.ResourcesPageModule) },
  { path: 'scarlet-game-jam', loadChildren: () => import('./scarlet-game-jam/scarlet-game-jam-page.module').then(m => m.ScarletGameJamPageModule) },
