...
export class MatButtonModifierDirective implements OnInit {
  ...
  ngOnInit() {
    ...
    if (!themeColors.includes(this.color)) {
      ...
      if (this.textColor) this.el.nativeElement.style.color = this.textColor;
    }

    if (this.tallButton) this.el.nativeElement.style.height = '3em';

    if (this.pill) this.el.nativeElement.style.borderRadius = '100em';
    ...
    if (this.roundTopLeft) this.el.nativeElement.style.borderTopLeftRadius = '2em';
    if (this.roundTopRight) this.el.nativeElement.style.borderTopRightRadius = '2em';
    if (this.roundBottomLeft) this.el.nativeElement.style.borderBottomLeftRadius = '2em';
    if (this.roundBottomLeft) this.el.nativeElement.style.borderBottomLeftRadius = '2em';
  }
}
