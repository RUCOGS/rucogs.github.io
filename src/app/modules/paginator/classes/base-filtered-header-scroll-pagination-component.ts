...
@Directive()
export abstract class BaseFilteredHeaderScrollPaginationComponent<TValue, TFilter> extends BaseFilteredScrollPaginationComponent<TValue, TFilter> implements AfterViewInit {
